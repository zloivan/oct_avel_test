...
- **Avoid static/singleton patterns** (anti-pattern in modern Unity development, especially in CIS market)
...
- Hybrid approach: DI for services, SerializeField for scene references (Unity best practice)
